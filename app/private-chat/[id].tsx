...
export default function PrivateChatScreen() {
  ...
  if (!contact) {
    return <View style={[styles.screen, styles.noContact, { backgroundColor: colors.background }]}><IconButton name="arrow-left" accessibilityLabel="Back" onPress={() => router.back()} /><Feather name="user-plus" size={28} color={colors.mutedForeground} /><Text style={[styles.emptyTitle, { color: colors.foreground }]}>No emergency contact selected</Text><Text style={[styles.emptyBody, { color: colors.mutedForeground }]}>Add a trusted contact from Home before starting a private chat.</Text></View>;
  }
...
const styles = StyleSheet.create({
  screen: { flex: 1 },
  noContact: { alignItems: 'center', justifyContent: 'center', padding: 28, gap: 10 },
